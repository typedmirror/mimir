...
# Invalid promotions
bad1: int = 3.14      # E: float not assignable to int
bad2: bool = 42       # E: int not assignable to bool
bad3: str = 5         # E: int not assignable to str
bad4: int = "hello"   # E: str not assignable to int
